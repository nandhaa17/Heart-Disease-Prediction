...
try:
    ...
    elif yes_val<65 and yes_val>=45:
        st.header(':orange[You Have Low Risk of Heart Disease]')
    else:
        st.header(':red[You Have High Risk of Heart Disease]')
